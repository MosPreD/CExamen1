...
void estadisticas_alumnos(Ficha* lista);
...
void menu() {
    ...
    while (1) {
        ...
        printf("3-Estadisticas\n"); // Nueva opción de estadísticas
        printf("4-Salir\n\n"); // Se eliminan las opciones de impresión y cálculos individuales
        ...
        switch (opcion) {
            ...
            case 2:
                ...
                break;
            case 3:
                printf("Opcion %i seleccionada: Estadisticas\n", opcion);
                estadisticas_alumnos(lista);
                break;
            case 4:
...
void manejo_archivos(Ficha* lista, int criterio) 
{
    ...
    if (criterio == 5)
	{
		...
		fprintf(archivoListas, "Estadísticas:\n");
    	estadisticas_alumnos(lista);
	} 
