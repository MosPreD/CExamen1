...
void contar_edad(Ficha* lista, FILE* archivo);
void contar_primos(Ficha* lista, FILE* archivo);
void contar_hermanos(Ficha* lista, FILE* archivo);
void contar_ciudad(Ficha* lista, FILE* archivo);
void contar_tocayos(Ficha* lista, FILE* archivo);
void contar_genero(Ficha* lista, FILE* archivo);

void estadisticas_alumnos(Ficha* lista, FILE* archivo);
        ...
        switch (opcion) {
            ...
            case 2:
                if (lista == NULL) {
                    ...
                    if (criterio == 5)
                    {
                    	estadisticas_alumnos(lista, archivoListas);
                    	break;
					}
                }
                break;
...
void manejo_archivos(Ficha* lista, int criterio) 
{
    ...
    if (criterio == 5)
	{
		...
		fprintf(archivoListas, "Estadisticas:\n");
    	estadisticas_alumnos(lista, archivoListas);
	} 
...
void estadisticas_alumnos(Ficha* lista, FILE* archivo) 
{
    contar_edad(lista, archivo);
    contar_primos(lista, archivo);
    contar_hermanos(lista, archivo);
    contar_ciudad(lista, archivo);
    contar_tocayos(lista, archivo);
    contar_genero(lista, archivo);
}
